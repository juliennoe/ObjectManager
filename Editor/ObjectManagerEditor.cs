...
public class ObjectManagerEditor : EditorWindow
{
    ...
    [MenuItem("Tools/Managers/Object Manager")]
    ...
    private void OnGUI()
    {
        ...
        if (showHelp)
        {
            ...
            string helpText =
                "-- Favorite Assets Tool

" +
                "This tool helps you manage favorite and recently selected assets in your project.

" +
                "★ Favorites:
" +
                "• Drag & drop any asset into the green area.
" +
                "• Use 'Reset Favorites' to clear the list.

" +
                "-- Recents:
" +
                "• When 'Start Storing' is active, every selected asset is tracked.
" +
                "• Limit tracked items with 'Max number of recents'.
" +
                "• 'Reset Recent' clears the recent list.

" +
                "- Start Storing / - Stop Storing:
" +
                "Toggle automatic tracking of selected assets.

" +
                "-- Remove:
" +
                "Click 'Remove' to delete individual items from either list.";
